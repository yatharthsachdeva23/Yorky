...
cur.execute('SELECT COUNT(*) FROM shorts WHERE video_id=%s', ('yBnFHlmgMFQ',))
print('shorts:', cur.fetchone()[0])

tables = ['performance_metrics', 'traffic_sources', 'search_terms', 'retention_curve',
...
cur.execute('SELECT COUNT(*) FROM analysis_log WHERE video_id=%s', ('yBnFHlmgMFQ',))
print('analysis_log entries:', cur.fetchone()[0])
